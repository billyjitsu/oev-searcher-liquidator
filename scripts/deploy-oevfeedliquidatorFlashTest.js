...
const deployLiquidator = async () => {
  ...
  const lendingPoolAddressProvider = process.env.LENDING_POOL_ADDRESS_PROVIDER;

  const OevLiquidatorArtifact = await hre.artifacts.readArtifact("OevLiquidatorSeparate");
