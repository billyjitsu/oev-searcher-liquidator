...
const calculateProjectedHealthFactor = async (
  ...
  try {
    ...
    const totalCollateralUSD =
      parseFloat(userData.totalCollateralETH) * AAVE_ETH_TO_USD_SCALING;
    const totalDebtUSD =
      parseFloat(userData.totalDebtETH) * AAVE_ETH_TO_USD_SCALING;
    ...
    const projectedHealthFactor =
      (newCollateralValueUSD * liquidationThreshold) / totalDebtUSD;
